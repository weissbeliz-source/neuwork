                      ...
                      content: (
                        <div style={{ display: "grid", gap: 14 }}>
                          <div>
                            ...
                            <textarea value={profile.experience} onChange={e => setProfile({ ...profile, experience: e.target.value })} placeholder="z.B. 09.2022 – heute | Firma | Position | - Aufgabe" rows={6} style={inp({ resize: "vertical" })} />
                          </div>
                          <div>
                            <label style={lbl}>Bildungsweg</label>
                            <textarea value={profile.education} onChange={e => setProfile({ ...profile, education: e.target.value })} placeholder="z.B. 10.2018 – 03.2022 | Hochschule | Abschluss" rows={4} style={inp({ resize: "vertical" })} />
                          </div>
